...
-   [Changed] CSS variables names are now shorter - to gain some of a space
-   [Changed] Toast animation
-   [Changed] Flex added min-width and min-height for each children
